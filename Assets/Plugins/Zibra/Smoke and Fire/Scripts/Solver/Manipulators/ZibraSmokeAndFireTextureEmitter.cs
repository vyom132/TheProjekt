...
namespace com.zibra.smoke_and_fire.Manipulators
{
    ...
    ///     </para>
    /// </remarks>
    [AddComponentMenu(Effects.SmokeAndFireComponentMenuPath + "Zibra Smoke & Fire Texture Emitter")]
...
#region Implementation details
        internal override SimulationData GetSimulationData()
        {
            ...
            Vector4[] additionalData = { new Vector4(isActiveAndEnabled ? 1.0f : 0.0f, rotatedInitialVelocity.x, rotatedInitialVelocity.y, rotatedInitialVelocity.z), new Vector4(0.0f, 0.0f, 0.0f, UseObjectVelocity ? 1.0f : 0.0f) };
