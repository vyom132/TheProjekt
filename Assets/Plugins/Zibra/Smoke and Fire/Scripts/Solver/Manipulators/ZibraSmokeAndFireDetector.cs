...
namespace com.zibra.smoke_and_fire.Manipulators
{
    ...
    /// </remarks>
    [AddComponentMenu(Effects.SmokeAndFireComponentMenuPath + "Zibra Smoke & Fire Detector")]
...
#region Implementation details
        ...
        private void Update()
        {
            ...
            if (LightToControl != null && LightToControl.type == LightType.Point)
            {
                ...
                Vector3 delta = new Vector3(transform.lossyScale.x * CurrentIlluminationCenter.x,
                                            transform.lossyScale.y * CurrentIlluminationCenter.y,
                                            transform.lossyScale.z * CurrentIlluminationCenter.z);
                LightToControl.transform.position = transform.position + delta;
            }
        }
